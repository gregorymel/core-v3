...
import {CreditManagerV32Harness} from "./CreditManagerV32Harness.sol";
...
contract CreditManagerV32UnitTest is TestHelper, ICreditManagerV3Events, BalanceHelper, CreditAccountMockEvents {
    ...
    CreditManagerV32Harness creditManager;
    PoolMock poolMock;
    ...
    function _deployCreditManager() internal {
        ...
        creditManager = new CreditManagerV32Harness(
            address(poolMock),
        ...
        creditManagerTest
    {
        ...
        LiquidateAccountTestCase[7] memory cases = [
            LiquidateAccountTestCase({
                ...
                amountToLiquidator: 0, //debt * 2 * DEFAULT_LIQUIDATION_PREMIUM / PERCENTAGE_FACTOR,
        ...
        for (uint256 i; i < cases.length; ++i) {
            ...
            collateralDebtData.quotedTokens = _case.quotedTokens;
            {
                ...
                IERC20(underlying).approve(address(creditManager), _amountWithFee(amountToPool));
                ...
                {
                    uint256 expectedRemainingFunds = _case.underlyingBalance - amountToPool
    ...
    function test_U_CM_09_liquidateCreditAccount_reverts_if_called_twice_a_block() public creditManagerTest {
        ...
        IERC20(underlying).approve(
            ...
            DAI_ACCOUNT_AMOUNT + 2 * DAI_ACCOUNT_AMOUNT * DEFAULT_FEE_LIQUIDATION / PERCENTAGE_FACTOR
        );
        ...
        creditManagerTest
    {
        ...
        vm.prank(creditAccount);
        IERC20(underlying).approve(address(creditManager), _amountWithFee(DAI_ACCOUNT_AMOUNT));
